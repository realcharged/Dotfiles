...
#+BEGIN_SRC bash
# start a terminal, change 'st -z 18' to the terminal of your choice
bindsym $mod+Return exec st -z 18
...
# YaCy
exec_always /home/charged/Downloads/keep/yacy_search_server/startYACY.sh
#+END_SRC
